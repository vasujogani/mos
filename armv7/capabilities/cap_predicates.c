...
bool is_ancestor(struct  capability* child,struct  capability* parent) {
    bool _fof_x426;
    genpaddr_t _fof_x427;
    genpaddr_t _fof_x428;
    gensize_t _fof_x429;
    gensize_t _fof_x430;
    struct  capability* child__420;
    struct  capability child__420__421;
    enum objtype child__420__421__424;
    struct  capability* parent__422;
    struct  capability parent__422__423;
    enum objtype parent__422__423__425;
 
    child__420 = child;
    child__420__421 = *child__420;
    parent__422 = parent;
    parent__422__423 = *parent__422;
    child__420__421__424 = child__420__421.type;
    parent__422__423__425 = parent__422__423.type;
    _fof_x426 = is_well_founded(parent__422__423__425,child__420__421__424);
    if ((! _fof_x426)){
        return (0);
    } else {
    }
    _fof_x427 = get_address(parent);
    _fof_x428 = get_address(child);
    _fof_x429 = get_size(parent);
    _fof_x430 = get_size(child);
    if ((child__420__421__424 == parent__422__423__425)){
        return ((((_fof_x427 < _fof_x428) & ((_fof_x427 + _fof_x429) >= (_fof_x428 + _fof_x430))) | ((_fof_x427 <= _fof_x428) & ((_fof_x427 + _fof_x429) > (_fof_x428 + _fof_x430)))));
    } else {
        return (((_fof_x427 <= _fof_x428) & ((_fof_x427 + _fof_x429) >= (_fof_x428 + _fof_x430))));
    }
}
 
bool is_copy(struct  capability* left,struct  capability* right) {
    int8_t _fof_x419;
    struct  capability* left__413;
    struct  capability left__413__414;
    enum objtype left__413__414__417;
    struct  capability* right__415;
    struct  capability right__415__416;
    enum objtype right__415__416__418;
 
    left__413 = left;
    left__413__414 = *left__413;
    right__415 = right;
    right__415__416 = *right__415;
    left__413__414__417 = left__413__414.type;
    right__415__416__418 = right__415__416.type;
    if ((left__413__414__417 != right__415__416__418)){
        return (0);
    } else {
    }
    switch (left__413__414__417) {
        case ObjType_IPI: {
            return (1);
            break;
        }
    ...
    _fof_x419 = compare_caps(left,right,0);
    return ((_fof_x419 == 0));
}
...
bool is_revoked_first(struct cte * src_cte,enum objtype src_type) {
    ...
    switch (src_type) {
        case ObjType_VNode_AARCH64_l3: {
            _fof_x412 = has_descendants(src_cte);
            if (_fof_x412){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_AARCH64_l2: {
            _fof_x411 = has_descendants(src_cte);
            if (_fof_x411){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_AARCH64_l1: {
            _fof_x410 = has_descendants(src_cte);
            if (_fof_x410){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_AARCH64_l0: {
            _fof_x409 = has_descendants(src_cte);
            if (_fof_x409){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_ARM_l2: {
            _fof_x408 = has_descendants(src_cte);
            if (_fof_x408){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_ARM_l1: {
            _fof_x407 = has_descendants(src_cte);
            if (_fof_x407){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_x86_32_ptable: {
            _fof_x406 = has_descendants(src_cte);
            if (_fof_x406){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_x86_32_pdir: {
            _fof_x405 = has_descendants(src_cte);
            if (_fof_x405){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_x86_32_pdpt: {
            _fof_x404 = has_descendants(src_cte);
            if (_fof_x404){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_x86_64_ptable: {
            _fof_x403 = has_descendants(src_cte);
            if (_fof_x403){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_x86_64_pdir: {
            _fof_x402 = has_descendants(src_cte);
            if (_fof_x402){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_x86_64_pdpt: {
            _fof_x401 = has_descendants(src_cte);
            if (_fof_x401){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_VNode_x86_64_pml4: {
            _fof_x400 = has_descendants(src_cte);
            if (_fof_x400){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_DevFrame: {
            _fof_x399 = has_descendants(src_cte);
            if (_fof_x399){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_Frame: {
            _fof_x398 = has_descendants(src_cte);
            if (_fof_x398){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_RAM: {
            _fof_x397 = has_descendants(src_cte);
            if (_fof_x397){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_PhysAddr: {
            _fof_x396 = has_descendants(src_cte);
            if (_fof_x396){
                return (0);
            } else {
                return (1);
